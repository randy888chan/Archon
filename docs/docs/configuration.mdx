...
- **OpenRouter** - Access 200+ models from multiple providers (Anthropic, OpenAI, Meta, Google, etc.)
...
- **OpenRouter**: Provides access to models from OpenAI, Anthropic, Meta, Google, and more
- **Mixed Providers**: You can use OpenRouter for LLM + OpenAI for embeddings
