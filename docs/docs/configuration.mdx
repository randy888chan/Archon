...
- **Azure OpenAI** - Enterprise-grade AI with your Azure subscription
...
- **Azure OpenAI**: Requires Azure OpenAI resource endpoint and deployment names
...
1. Select **"Azure OpenAI"** from the provider dropdown
2. Enter your **Azure OpenAI API Key**
3. Set your **Azure OpenAI Endpoint** (e.g., `https://your-resource.openai.azure.com`)
4. Configure **API Version** (default: `2024-12-01-preview`)
...
2. Select **"Azure OpenAI"** from LLM Provider dropdown
3. Configure Azure-specific settings:
   - **Azure OpenAI Endpoint**: Your resource endpoint URL
   - **API Version**: Azure OpenAI API version
4. Set your **deployment names**:
   - **Chat Model**: Your GPT deployment name (e.g., `gpt-4`)
   - **Embedding Model**: Your embedding deployment name (e.g., `text-embedding-3-small`)
5. Add **Azure OpenAI API Key** in Settings → API Keys
6. Click **"Save Settings"**

</TabItem>
</Tabs>

<Admonition type="info" title="Azure OpenAI Requirements">
- Active Azure subscription with Azure OpenAI resource
- Deployed models in your Azure OpenAI resource
- API key with appropriate permissions
- Resource endpoint URL from Azure portal
</Admonition>
