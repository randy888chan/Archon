...
- **OpenAI** (default) - Works with OpenAI and OpenAI-compatible services (Azure, Groq, MistralAI, etc.)
...
- **Custom Endpoints**: OpenAI provider supports custom endpoints for Azure, Groq, MistralAI, etc.
- **Ollama**: Requires local installation and custom base URL
- **Models**: Each provider has different model naming conventions
</Admonition>

#### OpenAI-Compatible Services Configuration

The OpenAI provider supports custom endpoints for various OpenAI-compatible services:

<Tabs>
<TabItem value="onboarding" label="During Onboarding">

1. Select **"OpenAI"** from the provider dropdown
2. Enter your **API key** (works for OpenAI, Azure, Groq, etc.)
3. Optionally check **"Use custom endpoint"** for non-OpenAI services
4. Enter your **custom endpoint URL** if using Azure, Groq, MistralAI, etc.
5. Click **"Save & Continue"**

</TabItem>
<TabItem value="settings" label="In Settings Page">

1. Go to **Settings → RAG Settings**
2. Select **"OpenAI"** from LLM Provider dropdown
3. Configure custom endpoint (optional):
   - **Custom OpenAI Endpoint**: Leave empty for OpenAI, or enter custom URL
4. Set your **model names**:
   - **Chat Model**: Model name or deployment name
   - **Embedding Model**: Embedding model or deployment name
5. Add **OPENAI_API_KEY** in Settings → API Keys
6. Click **"Save Settings"**

</TabItem>
</Tabs>

<Admonition type="info" title="Supported Services">
**OpenAI-Compatible Services:**
- **OpenAI**: Leave endpoint empty (default)
- **Azure OpenAI**: `https://your-resource.openai.azure.com/openai/deployments?api-version=2024-12-01-preview`
- **Groq**: `https://api.groq.com/openai/v1`
- **MistralAI**: `https://api.mistral.ai/v1`
- **Self-hosted**: vLLM, TGI, or any OpenAI-compatible server
</Admonition>
