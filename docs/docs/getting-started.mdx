...
- LLM provider API key (OpenAI, OpenRouter, Google, or Ollama setup)
...
2. Go to **Settings** → **RAG Settings** and configure your LLM provider:
   - **OpenAI**: Add OpenAI API key
   - **OpenRouter**: Add OpenRouter API key (access to 200+ models)
   - **Google**: Add Google API key
   - **Ollama**: Configure local installation
3. Configure embedding provider (OpenAI recommended for best results)
4. Start the MCP server from the **MCP Dashboard**
5. Get connection details for your AI client
