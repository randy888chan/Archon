...
- AI Provider: [OpenAI API key](https://platform.openai.com/api-keys) (works with OpenAI, Azure OpenAI, Groq, MistralAI, etc.)
...
OPENAI_API_KEY=sk-proj-your-openai-key        # For OpenAI and compatible services
# OPENAI_ENDPOINT=https://custom-endpoint.com # For Azure, Groq, MistralAI, etc. (optional)
...
2. Complete the onboarding flow to configure your AI provider (OpenAI-compatible services supported)
