...
- AI Provider: [OpenAI API key](https://platform.openai.com/api-keys) or [Azure OpenAI resource](https://portal.azure.com/)
...
# AZURE_OPENAI_API_KEY=your-azure-key        # For Azure OpenAI (alternative)
...
2. Complete the onboarding flow to configure your AI provider (OpenAI or Azure OpenAI)
