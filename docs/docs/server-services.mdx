...
- Supports multiple providers: OpenAI (with custom endpoints), Google Gemini, Ollama
- OpenAI-compatible interface for all providers
- Custom endpoint support for Azure OpenAI, Groq, MistralAI, vLLM, TGI
...
- `OPENAI_ENDPOINT` - Custom endpoint for Azure, Groq, MistralAI, etc. (optional)
