...
- Supports multiple providers: OpenAI, Azure OpenAI, Google Gemini, Ollama
...
- `AZURE_OPENAI_API_KEY` - For Azure OpenAI models and embeddings
- `GOOGLE_API_KEY` - For Google Gemini models
- `LLM_PROVIDER` - LLM provider selection (openai, azure, google, ollama)
