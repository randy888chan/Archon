...
"""
        ...
        @agent.tool
        async def search_documents(ctx: RunContext[RagDependencies], query: str, source_filter: str | None = None) -> str:
        ...
        @agent.tool
        async def search_code_examples(ctx: RunContext[RagDependencies], query: str, source_filter: str | None = None) -> str:
    ...
    async def run_conversation(self, user_message: str, project_id: str | None = None,
                              source_filter: str | None = None, match_count: int = 5,
