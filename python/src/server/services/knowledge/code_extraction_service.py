...
from ..storage.code_storage_service import add_code_examples_to_supabase, generate_code_summaries_batch
...
class CodeExtractionService:
    ...
    async def _extract_text_file_code_blocks(self, content: str, url: str, min_length: int | None = None) -> list[dict[str, Any]]:
        """
