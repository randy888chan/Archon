...
def process_markdown_document(file_path, processor):
    ...
    try:
        ...
        print("Phase 1: Building hierarchy tree...")
        doc_tree = processor.build_hierarchy_tree(parsed_doc)

        print("Phase 1: Applying classification...")
        classified_tree = processor.apply_classification(doc_tree) # Assuming this modifies the tree in-place or returns the modified tree
        ...
        print("Phase 2: Generating hierarchical chunks...")
        ...
        cross_ref_chunks = process_chunks(classified_tree) # Using classified_tree as input based on original code
        ...
        print("Document processing complete (Phases 1-3).")
