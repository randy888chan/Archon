...
if __name__ == "__main__":
    ...
    print("Chunker script run directly.", flush=True)
    print("To test, provide a sample document_tree dictionary.", flush=True)
        ...
        "children": [
            {
                ...
                "title": "Section 1",
                "level": 1,
                "content": "Content for section 1. More descriptive text.",
                "metadata": {
    ...
    print("\nProcessing sample tree...", flush=True)
    final_chunks = process_chunks(sample_tree)
    print(f"\nGenerated {len(final_chunks)} final chunks from sample.", flush=True)
