...
def environment_tab():    
    ...
    with st.form("env_vars_form"):
        ...
        # VECTOR_DIMENSION
        vector_dimension_help = "The dimension of the vectors generated by your embedding model.\n\n" + \
                                "Example for nomic-embed-text: 768\n\n" + \
                                "Example for text-embedding-3-small: 1536"

        vector_dimension = st.text_input(
            "VECTOR_DIMENSION:",
            value=profile_env_vars.get("VECTOR_DIMENSION", ""),
            help=vector_dimension_help,
            key="input_VECTOR_DIMENSION"
        )
        updated_values["VECTOR_DIMENSION"] = vector_dimension
